...
export async function GET(request) {
  ...
  try {
    ...
    const protectedBrands = ['SpeedPost Express', 'SpeedPost Priority', 'SpeedPost Saver', 'DHL Express', '(ePAC)s', '(EMS)'];
    ...
    try {
      ...
      if (targetLang) {
        const langCodeMap = {
          ...
          'ja': 'ja', 'ko': 'ko', 'zh': 'zh-CN', 'zh-cn': 'zh-CN', 'zh-hans': 'zh-CN', 'zh-hant': 'zh-TW', 'zh-tw': 'zh-TW', 'zh-hk': 'zh-TW', 'yue': 'yue',
