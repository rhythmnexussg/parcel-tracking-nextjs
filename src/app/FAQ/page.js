...
const confirmationFaqTranslations = {
  ...
  yue: {
    question: "如果我凇收到確認電郵點算？",
    answer: "1. 請先檢查垃圾郵件資料夾——自動郵件有時會被過濾。\n2. 確認你結帳時用嘅電郵地址；拼錯字可能導致唔能送達。\n3. 若地址正確但仍凇收到，請提供訂單號及你用嘅電郵（或電話）聯絡我們。我們可以重新發送確認信或手動提供訂單資訊。\n\n你亦可以前往 https://rhythmnexus.org/track-your-item ，使用 Search by Email or Phone 查詢你嘅訂單。"
  },
  no: {
...
Important: Missing recipient phone number may result in shipment delays, return-to-sender outcomes, or order cancellation depending on destination-country processing rules. Rhythm Nexus will cancel the order after 24 hours and issue a full refund if the required phone number is not provided.`
  ...
  tl: { question: "Kailangan ang phone number para sa shipping (Mahalaga)", answer: `Para sa ilang destinasyon, mandatory ang valid na phone number ng recipient para sa Etsy shipments. Nakakatulong ito sa customs clearance, VAT/buwis coordination, at final-mile delivery communication. Pangunahing destinasyon: USA, EU countries (kabilang ang Alemanya), United Kingdom, Norway, Switzerland, China, India, Indonesia, Pilipinas, South Korea, Taiwan, at Vietnam. Recommended (hindi required): Australia, New Zealand, Canada. Kapag walang number, puwedeng ma-delay, ma-return, o ma-cancel ang order. Ika-cancel ng Rhythm Nexus pagkalipas ng 24 oras at magbibigay ng full refund kung hindi maibigay ang required number.` },
  ...
  ta: { question: "அனுப்புவதற்கு தொலைபேசி எண் அவசியம் (முக்கியம்)", answer: `சில இலக்குகளுக்கு Etsy அனுப்புதல்களில் பெறுநரின் செல்லுபடுகிற தொலைபேசி எண் கட்டாயம். இது சுங்க அனுமதி, VAT/வரி ஒருங்கிணைப்பு மற்றும் இறுதி ටிலிவரி தொடர்புக்கு உதவுகிறது. முக்கிய இலக்குகள்: அமெரிக்கா, ஐரோப்பிய ஒன்றிய நாடுகள், ஐக்கிய இராஜ்சியம், நார்வே, சுவிட்சர்லாந்து, சீனா, இந்தியா, இந்தோனேஷியா, பிலிப்பைன்ஸ், தென் கொரியா, தைவான் மற்றும் வியட்நாம். பரிந்துரை (கட்டாயமில்லை): ஆஸ்திரேலியா, நியூசிலாந்து, கனடா. எண் இல்லெனில் தாமதம், திரும்புதல் அல்லது ரத்து ஏற்படலாம். 24 மணிநேரத்தில் தேவையான எண் தரப்படாவிட்டால் Rhythm Nexus ஆர்டரை ரத்து செய்து முழு பணத்தீர்வை வழங்கும்.` },
  yue: { question: "出貨需提供電話號碼（重要）", answer: `對於部分目的地，Etsy 出貨必須提供有效收件人電話號碼。呢個有助清關、VAT/稅務協調及末端配送溝通。主要適用國家/地區包括：美國、歐盟國家、英國、挪威、瑞士、中國、印度、印尼、菲律賓、南韓、台灣與越南。建議提供（非強制）：澳洲、紐西蘭、加拿大。若缺少號碼，可能造成延誤、退回或取消。若 24 小時內未提供所需號碼，Rhythm Nexus 將取消訂單並全額退款。` }
};
